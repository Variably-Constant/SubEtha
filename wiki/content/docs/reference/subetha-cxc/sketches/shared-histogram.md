...
block-beta
  columns 1
  hdr["HistogramHeader - 64 B: magic, n_boundaries, total_count (atomic)"]
  b["boundaries [u64; K] - ascending"]
  c["counters [AtomicU64; K + 1] - per-bucket counts"]
  classDef hdrC fill:#1e3a8a,color:#ffffff
  classDef bC fill:#475569,color:#ffffff
  classDef cC fill:#0f766e,color:#ffffff
  class hdr hdrC
  class b bC
  class c cC
```
...
- Source: `crates/subetha-cxc/src/shared_histogram.rs` (581
  lines, unit tests covering record + bucket placement,
