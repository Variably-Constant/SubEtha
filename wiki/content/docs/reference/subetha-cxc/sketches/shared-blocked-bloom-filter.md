---
title: "Shared Blocked Bloom Filter"
weight: 25
---
...
- Bench: `crates/subetha-cxc/benches/shared_blocked_bloom_filter.rs`
  ...
  filter).
- Sibling primitive: [SharedBloomFilter](shared-bloom-filter/)
  - the standard scatter-probe filter; the blocked variant trades
  1.15x the bits for one-line access.
- Sibling primitive: [SharedCountMinSketch](shared-count-min-sketch/)
