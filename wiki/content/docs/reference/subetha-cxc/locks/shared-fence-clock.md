...
block-beta
  columns 1
  hdr["HlcHeader - 64 B: magic, capacity, global_fence_physical, global_fence_logical"]
  s0["HlcSlot 0 - 64 B: pid, physical, logical"]
  s1["HlcSlot 1 - same shape"]
  dots["..."]
  sn["HlcSlot capacity - 1"]
...
- Source: `crates/subetha-cxc/src/shared_fence_clock.rs` (609
  lines, unit tests covering tick monotonicity, merge rules,
