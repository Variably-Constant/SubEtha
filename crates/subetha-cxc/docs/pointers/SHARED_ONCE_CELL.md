...
- **`T: Copy + 'static`**. Payload up to 56 bytes.
- **Three-state machine**: EMPTY (0) /
  INITIALIZING (1) / INITIALIZED (2).
- **CAS-based winner election**: first writer to CAS EMPTY -> INITIALIZING wins
...
- Sibling primitive: [SHARED_LEADER_ELECTION.md](./SHARED_LEADER_ELECTION.md) -
